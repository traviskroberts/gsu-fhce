 ...
 * admin.java
 *
 * Created on October 13, 2006, 7:01 PM
 */
    ...
    throws ServletException, IOException {
        ...
        if(action.equals("edit_events")) {
            ...
            if(request.getParameter("month") != null) {
                ...
                // build query string based on month number,
                // make sure that single digits are made double digits
                if(month < 10) {
        ...
        // if they are updating the event
            ...
            if(request.getParameter("all_day") == null) {
                ...
                // build start times and end times
                // make the hour double digits
        ...
        // if they are saving a calendar event
            ...
            // get a current Alumni object
            Alumni cur_alumni = person.getAlumni();
            
            // get alumni form details
            ...
            Person person = new Person();
            person = person.getPerson(person_id);
            // get a current Hospital object
            Hospital cur_hospital = person.getHospital(person_id);
            
            // get hospital form details
            String fname = request.getParameter("fname");
            String lname = request.getParameter("lname");
            String address1 = request.getParameter("address1");
            String address2 = request.getParameter("address2");
            ...
            String content = request.getParameter("content");
            int parent_id = 0;
            // get the parent_id if it exists
            if(request.getParameter("parent_id") != null) {
 ...
 * @author Shane Severy
 */
        //Gets an admin listing of residencies.
        ...
        //Edits the residency from admin.
            ...
            dbResultSet = residency.getResidency(job_id);
                if (dbResultSet != null) {
                    try {
                        ...
                        //Gets the hospital name based on it's id.
        ...
        //Prepares to add a new residency
        ...
        //Adds a new hospital for from admin
