...
<form action="/gsu_fhce/residency" method="post">
...
<p>
    Description<br />
<textarea name="description" id="description" rows="6" cols="50"><%= result.getString("description") %>
</textarea>
</p>

    <input type="hidden" name="job_id" value="<%= result.getString("id") %>" />
    <input type="hidden" name="action" value="save_residency" />
