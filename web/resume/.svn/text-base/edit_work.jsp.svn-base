...
<form action="/gsu_fhce/resume" method="post">
    <p>
        Company Name<br />
        <input type="text" name="company" id="company" class="formfield" value="<%= company_name %>" />
    </p>
    <p>
        Position<br />
        <input type="text" name="position" id="position" class="formfield" value="<%= position %>" />
    </p>
    <p>
        City, State<br />
    ...
    <p>
        ...
        <input type="button" name="update" value="Update Work Experience" onclick="checkWork(this.form, 'update_work'); return false" />
    </p>
</form>
