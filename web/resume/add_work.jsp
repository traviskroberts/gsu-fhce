...
<% if(in_process.equals("yes")) { %>
    <img src="/gsu_fhce/images/resume_step2.png" />
<% } %>
...
<form action="/gsu_fhce/resume" method="post">
    <p>
        Company Name<br />
        <input type="text" name="company" id="company" class="formfield" />
    </p>
    <p>
        Position<br />
        <input type="text" name="position" id="position" class="formfield" />
    </p>
    <p>
        City, State<br />
    ...
    <p>
        End Date (leave blank if current)<br />
        <select name="end_month" id="end_month" class="selectfield">
            <option value="">month</option>
            <option value="01">January</option>
            <option value="02">February</option>
            <option value="03">March</option>
        ...
        <select name="end_year" id="end_year" class="selectfield">
            <option value="">year</option>
            <option value="1990">1990</option>
            <option value="1991">1991</option>
            <option value="1992">1992</option>
    ...
    <% if(in_process.equals("yes")) { %>
        <input type="button" name="add_more" value="Add More Work" onclick="checkWork(this.form, 'work_add_more'); return false" />
        &nbsp;&nbsp;&nbsp;
        <input type="button" name="continue" value="Continue to Skills" onclick="checkWork(this.form, 'work_continue'); return false" />
    <% } else { %>
        <input type="button" name="additional" value="Add Work" onclick="checkWork(this.form, 'save_more_work'); return false" />
    <% } %>
    </p>
</form>
